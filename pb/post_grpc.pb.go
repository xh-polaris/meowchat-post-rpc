...
func (c *postClient) GetManyPost(ctx context.Context, in *GetManyPostReq, opts ...grpc.CallOption) (*GetManyPostResp, error) {
	out := new(GetManyPostResp)
	err := c.cc.Invoke(ctx, "/post.post/GetManyPost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *postClient) AddPost(ctx context.Context, in *AddPostReq, opts ...grpc.CallOption) (*AddPostResp, error) {
	out := new(AddPostResp)
	err := c.cc.Invoke(ctx, "/post.post/AddPost", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PostServer interface {
	GetManyPost(context.Context, *GetManyPostReq) (*GetManyPostResp, error)
...
func (UnimplementedPostServer) GetManyPost(context.Context, *GetManyPostReq) (*GetManyPostResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetManyPost not implemented")
}
func (UnimplementedPostServer) GetPost(context.Context, *GetPostReq) (*GetPostResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPost not implemented")
}
func (UnimplementedPostServer) AddPost(context.Context, *AddPostReq) (*AddPostResp, error) {
...
func _Post_GetManyPost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetManyPostReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PostServer).GetManyPost(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/post.post/GetManyPost",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostServer).GetManyPost(ctx, req.(*GetManyPostReq))
	}
...
var Post_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetManyPost",
			Handler:    _Post_GetManyPost_Handler,
		},
		{
			MethodName: "GetPost",
