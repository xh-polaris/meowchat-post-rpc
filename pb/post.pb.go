...
func (x *SearchPostResp) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *ListPostResp) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *ListPostByUserIdResp) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
var file_post_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x81, 0x01, 0x0a,
	...
	0x01, 0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x6f, 0x0a, 0x13, 0x4c, 0x69,
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0xab, 0x03, 0x0a, 0x08,
